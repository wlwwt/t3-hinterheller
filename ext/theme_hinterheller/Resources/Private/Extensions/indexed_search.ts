...
lib.extensions.indexed_search_box {
	...
	20 {
		insertData = 1
		value (
			<input type="text" class="span2" placeholder="{LLL:EXT:theme_hinterheller/Resources/Private/Language/locallang.xml:search-placeholder}">
				<button class="btn btn-mini">{LLL:EXT:theme_hinterheller/Resources/Private/Language/locallang.xml:search-submit}</button>
			</form>
		)
	}
}