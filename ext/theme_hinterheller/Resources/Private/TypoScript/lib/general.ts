...
lib.copyright_information {
	...
	10 {
		data = date:U
		strftime = %Y
		noTrimWrap = || {LLL:EXT:theme_hinterheller/Resources/Private/Language/locallang.xml:copyright}|
...
lib.footer_logo {
	10 = IMAGE
	10 {
		file = EXT:theme_hinterheller/Resources/Public/Template/img/logo-government-package-footer.png
	}
}
